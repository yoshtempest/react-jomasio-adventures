...
import { canSpendPoints } from "@/gameRules/menu/rules/validation";
import { STATS } from "@/gameRules/menu/constants/stats";
import { circularNext, circularPrev } from "@/gameRules/menu/rules/navigation";
