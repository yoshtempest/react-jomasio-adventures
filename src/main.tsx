...
const CombatTutorial = lazyLoad(
  () => import("./pages/CombatTutorial/index.tsx"),
);

const CantinaBattle = lazyLoad(
  () => import("./pages/Cantina/Battle/index.tsx"),
);
...
const PcRoomBattleOne = lazyLoad(
  () => import("./pages/PcRoom/Battle/One/index.tsx"),
);
const PcRoomBattleTwo = lazyLoad(
  () => import("./pages/PcRoom/Battle/Two/index.tsx"),
);
const PcRoomBattleThree = lazyLoad(
  () => import("./pages/PcRoom/Battle/Three/index.tsx"),
);
const PlanetarySistersBattle = lazyLoad(
  () => import("./pages/Hall/Battle/Two/index.tsx"),
);
const MauraoBattle = lazyLoad(
  () => import("./pages/Hall/Battle/Three/index.tsx"),
);
const PcRoomPage = lazyLoad(() => import("./pages/PcRoom/index.tsx"));

const LibraryPage = lazyLoad(() => import("./pages/Library/index.tsx"));
const FootballCourtPage = lazyLoad(
  () => import("./pages/FootballCourt/index.tsx"),
);

const FootballCourtBattle = lazyLoad(
  () => import("./pages/FootballCourt/Battle/index.tsx"),
);

const VandinhaFragmentBattle = lazyLoad(
  () => import("./pages/Battle/Vandinha/index.tsx"),
);
const GoatBattle = lazyLoad(() => import("./pages/Battle/Goat/index.tsx"));
const JhowSimarBattle = lazyLoad(
  () => import("./pages/Battle/JhowSimar/index.tsx"),
);
const HungryDeathBattle = lazyLoad(
  () => import("./pages/Battle/Hungry/index.tsx"),
);
const TechnobladeBattle = lazyLoad(
  () => import("./pages/Battle/Technoblade/index.tsx"),
);

const CafeteriaBattle = lazyLoad(
  () => import("./pages/Cafeteria/Battle/index.tsx"),
);
...
const BrodiclassBattle = lazyLoad(
  () => import("./pages/BrodiClass/Battle/index.tsx"),
);
const HellroomPage = lazyLoad(() => import("./pages/HellRoom/index.tsx"));
const HellroomBattle = lazyLoad(
  () => import("./pages/HellRoom/Battle/index.tsx"),
);
                                    ...
                                    <Routes>
                                      <Route path="/" element={<App />}>
                                        ...
                                        <Route path="hall">
                                          ...
                                          />
                                          <Route
                                            path="pandemony/battle"
                                            element={<MauraoBattle />}
                                          />
                                        </Route>
                                        ...
                                        <Route path="footballcourt">
                                          <Route
                                            index
                                            element={
                                              <Navigate to="/footballcourt/one" />
                                            }
                                          />
                                          <Route
                                            path=":id"
                                            element={<FootballCourtPage />}
                                          />
                                          <Route
                                            path="battle"
                                            element={<FootballCourtBattle />}
                                          />
                                        </Route>
                                        ...
                                        <Route path="hellroom">
                                          <Route
                                            index
                                            element={
                                              <Navigate to="/hellroom/one" />
                                            }
                                          />
                                          <Route
                                            path=":id"
                                            element={<HellroomPage />}
                                          />
                                          <Route
                                            path="battle"
                                            element={<HellroomBattle />}
                                          />
                                        </Route>
                                        ...
                                        <Route path="pcroom">
                                          ...
                                          <Route
                                            path="battle/one"
                                            element={<PcRoomBattleOne />}
                                          />
                                          <Route
                                            path="battle/two"
                                            element={<PcRoomBattleTwo />}
                                          />
                                          <Route
                                            path="battle/three"
                                            element={<PcRoomBattleThree />}
                                          />
                                        </Route>
