...
export const BATTLE_CONFIGS: Record<string, BattleConfig> = {
  cafeteria: {
    ...
    audioSrc: "/assets/songs/background/battle/DarkSouls.m4a",
  },
  cantina: {
    npcType: "jhowsimar",
    ...
    audioSrc: "/assets/songs/background/battle/StreetFighter5KenTheme.m4a",
  },
  hellroom: {
    npcType: "maugrelo",
    ...
    audioSrc: "/assets/songs/background/battle/GuiltyGear/MaysThemeBlueWaterSky.mp3",
  },
  brodiclass: {
    npcType: "srGuaxinim",
    ...
    audioSrc: "/assets/songs/background/battle/SpiderDance.m4a",
  },
  footballCourt: {
    npcType: "neimito",
  ...
  hallCenter: {
    ...
    audioSrc: "/assets/songs/background/battle/KickBack.mp3",
  },
  hallPandemony: {
    npcType: "maurao",
  ...
  hungry: {
    ...
    audioSrc: "/assets/songs/background/battle/OriginalConcept.mp3",
  },
  jhowsimar: {
    npcType: "jhowsimar",
    onVictory: ({ navigate }) => { navigate(-1); },
  ...
  vandinha: {
    ...
    background: sceneBackgrounds.PcRoomBattle,
    victoryDescription: "Você derrotou um fragmento de Vandinha",
    audioSrc: "/assets/songs/background/battle/Jojo.m4a",
  },
};
