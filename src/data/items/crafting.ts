...
export const CRAFT_DROP_TABLES: Record<string, ClassDropTable> = {
  common: {
    always: [
      { id: "hungry_essence", chance: 0.6, qty: [1, 3] },
    ],
    perNpcType: {
      figurantOfBaalCult: [
  ...
  rare: {
    always: [
      { id: "rare_scale", chance: 0.5, qty: [1, 2] },
    ],
    perNpcType: {
      goat: [
  ...
  epic: {
    always: [
      { id: "epic_core", chance: 0.4, qty: [1, 2] },
    ],
  },
  boss: {
    always: [
      { id: "boss_soul", chance: 1.0, qty: [1, 1] },
    ],
  },
  legendary: {
    always: [
      { id: "legendary_fragment", chance: 1.0, qty: [1, 1] },
    ],
  },
};
