export const hallJailsonSevenDialogue = [
    {
        ...
        name: "Jailson",
        message:
            "Agora que eu tô relaxado, lembrei que preciso de...",
    },
    {
        isPlayer: true,
        name: "Protagonista",
        message:
            "E lá vamos nós de novo, o que você quer dessa vez?",
    },
    {
        src: "/assets/npcs/jailson/right.svg",
        name: "Jailson",
    ...
    },
    {
        ...
        name: "Protagonista",
        message:
            "Como você sabe tanto sobre mim, caralho?",
    },
    {
        src: "/assets/npcs/jailson/right.svg",
        name: "Jailson",
        message:
            "Quem sabe, sabe, agora vai lá",
    },
];