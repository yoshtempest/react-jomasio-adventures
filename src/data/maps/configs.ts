export const configsDialogue = [
    {
        src: "/src/assets/npcs/victor/lyingDown.svg",
        name: "Victor",
        message:
            "...",
    },
    {
        src: "/src/assets/npcs/victor/teleport.svg",
        name: "Victor",
        message:
            "...",
    },
    {
        src: "/src/assets/npcs/victor/talking.svg",
        name: "Victor",
        message:
            "Prazer, meu nome é Victor, eu sou um Novato nesse trampo de 'sistema' e estou aqui para lhe ensinar o básico",
    },
    {
        src: "/src/assets/npcs/victor/pointing.svg",
        name: "Victor",
        message:
            "Bem, tipo assim, você-",
    },
