export const cantinaMessages: Record<string, string> = {
  "2,6":
    "Estudos aponta que após dezenas de horas escutando uma música, ela começa a ficar tocando em loop na cabeça de quem escuta durante um tempo indeterminado.",
  "1,6": "Uma vez que você entra no Jorjão, é impossível sair...",
  "3,7":
    "Quanto mais tempo alguem passa sem comer, maiores as chances de sintomas como gastura e fraqueza.",
  "4,7":
    "Gnar, Rengar, Yuumi, Clarinha, Política, Quietinho... Dezenas de nomes, o que isso deveria significar?",
  "4,6":
