...
export const HellRoomDialogue = defineDialogue([
  ...
  ["protagonista", "Que? Eu estava prestes a descer a mão naquele cara...", "crossArms"],
  ...
  ["homemDesconhecido", "Não há tempo para perguntas, por favor me responda uma coisa RÁPIDO!"],
