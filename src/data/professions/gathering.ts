...
export const GATHER_LOOT_TABLES: Record<ProfessionId, GatherLootEntry[]> = {
  ...
  chef: [],
  lumberjack: [
    { itemId: "oak_wood", baseQty: 2, tier: "common" },
    { itemId: "eucalyptus_wood", baseQty: 1, tier: "rare" },
    { itemId: "birch_wood", baseQty: 1, tier: "rare" },
    { itemId: "jungle_wood", baseQty: 1, tier: "rare" },
    { itemId: "cherry_wood", baseQty: 1, tier: "epic" },
  ],
  bodyBuilder: [],
  mechanic: [],
  painter: [],
